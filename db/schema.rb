...
ActiveRecord::Schema.define(version: 2020_09_17_031552) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_management_id"], name: "index_buyers_on_purchase_management_id"
  end
  ...
  add_foreign_key "buyers", "purchase_managements"
